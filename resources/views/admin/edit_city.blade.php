        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Edit Cities</h4>
                </div>
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item"><a href="{{ url('city') }}">Cities</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route("update_city",$city->id)}}" class="form-material form-horizontal m-t-30" method="POST">
                                {{csrf_field()}}
                                 @method('PUT') 
                                <div class="form-group">
                                    <label class="col-md-12">City Name</label>
                                    <div class="col-md-12">
                                        <input class="form-control" value="{{ $city->city_name }}" id="name" name="name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Other details</label>
                                    <div class="col-md-12">
                                        <input class="form-control" value="{{ $city->other_details }}" id="name" name="other_details">
                                    </div>
                                </div>
                                
                                <button type="submit"  class="btn btn-info waves-effect waves-light m-r-10 text-white">Submit</button>
                                <a href="{{ url('city') }}" class="btn btn-secondary  active" role="button" aria-pressed="true">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
