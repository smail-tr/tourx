                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            ...
                            <a href="{{ route('all_tours') }}">View Details &rarr;</a>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            ...
                            <a href="{{ route('all_bookings') }}">View Details &rarr;</a>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            ...
                            <a href="{{ route('all_blogs') }}">View Details &rarr;</a>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-warning shadow h-100 py-2">
                        <div class="card-body">
                            ...
                            <a href="{{ route('all_plans') }}">View Details &rarr;</a>
