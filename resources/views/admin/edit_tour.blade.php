                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update_tour', $tour->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" value="{!! $tour->tour_name !!}" id="name"
                                            name="name">
                                    </div>
                                </div><br>
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control" name="city" id="city_id">
                                            @foreach ($city as $item)
                                                <option value="{{ $item->id }}" selected>{{ $item->city_name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        {{-- <input class="form-control" value="{{ $tour->description }}" rows="8"
                                            ...
                                            <textarea class="form-control" name="description" id="summernote" cols="30" rows="10">{!! $tour->description !!}</textarea>
                                    </div>
                                </div><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="file" class="form-control" value="{{ $tour->imageName }}" id=""
                                            name="imageName">
                                    </div>
                                    <div id="img_show" style="margin-left: 10px"><img
                                            style="border:dotted 1px red;border-raduis:30%"
                                            src="{{ URL::asset('uploads/tour/' . $tour->imageName) }}" height="200px"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" value="{{ $tour->start_place }}" id=""
                                            name="start_place">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" value="{{ $tour->duration }}" type="time"
                                            name="duration" id="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control" value="{{ $tour->price }}" id="" name="price">
                                    </div>
                                </div>
                                ...
                                <a href="{{ url('all_tours') }}" class="btn btn-secondary  active" role="button"
...
<script>
            var markupStr = "{!! $tour->tour_description !!}";
